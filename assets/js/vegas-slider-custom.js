...
//*********************Google MAP *********************/
		...
		var saturation = 100 // 
		var mapLatitude=25.257063 
		var mapLongitude=55.290456//(First Value Latitude, Second Value ), get YOUR coordenates here!: http://itouchmap.com/latlong.html
		var mapZoom_value=16 // Map zoom level parameter only numeric  


// Google map marker example 2 locations 
		//map-marker #1
		var marker1_Latitude=25.257063 
		var marker1_Longitude=55.290456
		var marker1_content="<h2>Sai Kiran</h2> UAE" // marker or  on click content (Info Window) 
		var marker1_pointerUrl = 'assets/img/map-marker.png' // set your color pointer here!

		//map-marker #2
		var marker2_Latitude=25.257063
		var marker2_Longitude=55.290456
		var marker2_content="<h2>Sai Kiran</h2>Bur Dubai" // marker or  on click content (Info Window) 
